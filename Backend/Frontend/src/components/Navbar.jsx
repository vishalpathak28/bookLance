    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky
            ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-6]00 dark:text-white duration-300 transition-all ease-in-out"
            : ""
          }`}
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className=" text-2xl font-bold cursor-pointer">bookLance</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <label className="swap swap-rotate">
              ...
              <svg
                className="swap-off w-7 h-7 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              {/* moon icon */}
              <svg
                className="swap-on w-7 h-7 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
